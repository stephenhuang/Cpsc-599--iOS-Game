...
-(void)loadParallax2{
    parallaxView = [[UIView alloc] init];
    parallaxView.frame = self.view.frame;
    parallaxView.tag = 1;
    // setting background color to black
    [parallaxView setBackgroundColor:[UIColor whiteColor]];
    ...
    [_firstScrollView setPagingEnabled:TRUE];
    [_firstScrollView setContentSize:CGSizeMake(4416, 1024)]; // 8 12
    [parallaxView addSubview:_firstScrollView];
    ...
    [_secondScrollView setContentSize:CGSizeMake(1809, 1024)];   // 4 6 was 3072, 1028
    [_secondScrollView setPagingEnabled:TRUE];
    [parallaxView addSubview:_secondScrollView];
    ...
    // underlying scrollviews
    // UI menu Buttons and labels go here
    [_thirdScrollView setDelegate:parallaxView];
    [_thirdScrollView setPagingEnabled:TRUE];
    [parallaxView addSubview:_thirdScrollView];
    
    //Label
    titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 200, 1000, 200)];
    titleLabel.text = @"Scrubbles";
    titleLabel.textColor = [UIColor blueColor];
    [titleLabel setFont:[UIFont fontWithName:@"Helvetica Neue" size:80]];
    [_thirdScrollView addSubview:titleLabel];
    
    titleLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(768+400, 60, 200, 44.0)];
    titleLabel2.text = @"How to Play";
    titleLabel2.textColor = [UIColor blueColor];
    [titleLabel2 setFont:[UIFont fontWithName:@"Helvetica Neue" size:20]];
    [_thirdScrollView addSubview:titleLabel2];
